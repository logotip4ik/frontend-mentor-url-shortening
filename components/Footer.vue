<template>
  <footer class="footer">
    <div class="footer__layout">
      ...
      <div class="footer__layout__links">
        <ul class="footer__layout__links__list">
          <li
            class="
              footer__layout__links__list__item
              footer__layout__links__list__item--header
            "
          >
            Features
          </li>
          <li class="footer__layout__links__list__item">Link Shortening</li>
          <li class="footer__layout__links__list__item">Branded Links</li>
          <li class="footer__layout__links__list__item">Analytics</li>
        </ul>
        <ul class="footer__layout__links__list">
          <li
            class="
          ...
          <li class="footer__layout__links__list__item">Blog</li>
          <li class="footer__layout__links__list__item">Developers</li>
          <li class="footer__layout__links__list__item">Support</li>
        </ul>
        <ul class="footer__layout__links__list">
          <li
            class="
          ...
          <li class="footer__layout__links__list__item">About</li>
          <li class="footer__layout__links__list__item">Our Team</li>
          <li class="footer__layout__links__list__item">Careers</li>
          <li class="footer__layout__links__list__item">Contact</li>
        </ul>
      </div>
      <ul class="footer__layout__social">
        <li class="footer__layout__social__icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
